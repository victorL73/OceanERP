...
public sealed record MailServerSettingsDto(Guid? Id, string SmtpHost, int SmtpPort, string ImapHost, int ImapPort, bool UseSsl, bool ImapAutoSyncEnabled, int ImapSyncIntervalMinutes, Guid? DefaultSystemMailAccountId, bool IsConfigured);
...
public sealed record UpdateMailServerSettingsRequest(string SmtpHost, string ImapHost, int SmtpPort = 587, int ImapPort = 993, bool UseSsl = true, bool ImapAutoSyncEnabled = true, int ImapSyncIntervalMinutes = 5, Guid? DefaultSystemMailAccountId = null);
