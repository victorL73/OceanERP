...
public sealed record CreateProductRequest(string Reference, string Name, string? Description, decimal PurchasePrice, decimal SalePrice, decimal VatRate, Guid? CategoryId, Guid? MainSupplierId);
public sealed record UpdateProductRequest(string Name, string? Description, decimal PurchasePrice, decimal SalePrice, decimal VatRate, Guid? CategoryId, Guid? MainSupplierId, bool IsActive);
